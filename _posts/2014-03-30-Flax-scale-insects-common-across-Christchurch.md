...
This is not one of the insects in my [core wild counts species list](../../../../../count/what-to-count-intro/), so I have not been accumulating data to show where it's found and how it's changing in abundance. That would be interesting to do though.
