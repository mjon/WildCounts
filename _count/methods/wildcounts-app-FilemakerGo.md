...
I've been using this WildCounts Filemaker Go app daily for almost a decade now. I still regard it as a prototype for a standalone app. I've designed that app but haven't mastered all the skills, and made the time, to build it yet. I've also got scripts set up using Amazon Transcribe to automatically transcribe and then autocorrect and format my spoken wild counts. When I started collecting wild counts as audio notes, I was banking on a future where it would be possible to use computers to automate the accurate transciption of noisy outdoor field notes. We're entering that future now.
